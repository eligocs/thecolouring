        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('cartoonimages') }}" method="post" id="cartoon" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text" class="form-control" placeholder="Image Text">
                                    </div>                                    
                                </div>
                            </div>
                        </div> 
               ...
               var dropzoneOptions = {
                   ...
                   init: function() {
                       this.on("success", function(file, res){
                             ...
                             $('#cartoon').append('<input type="hidden" name="cartoonimage" value="' + file.name + '">');

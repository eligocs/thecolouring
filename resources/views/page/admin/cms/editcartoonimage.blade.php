        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Edit Multiple Images </h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                        {!! implode('', $errors->all('<div style="color:red">:message</div>')) !!}
                    @endif
                    <form action="{{ url('cartoonimages') }}" method="post" id="editcartoon" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <img src="{{ asset('upload/cms/'.$edit->images) }}" height="100px" width="100px">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="text" value="{{ isset($edit->text) ? $edit->text : '' }}" class="form-control" placeholder="Image Text">
                                    </div>                                    
                                </div>
                            </div>
                        </div> 

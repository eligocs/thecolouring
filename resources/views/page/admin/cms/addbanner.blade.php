            ...
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Add Home Banner Images & Text </h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ url('create/banner') }}" method="post" id="banner" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <hr>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="text1" class="form-control" placeholder="text 1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="text2" class="form-control" placeholder="text 2">
                                        </div>
                                    </div>                            
                                </div>
                ...
                var dropzoneOptions = {
                    ...
                    init: function() {
                        this.on("success", function(file, res){
                              ...
                              $('#banner').append('<input type="hidden" name="bannerimage" value="' + file.name + '">');

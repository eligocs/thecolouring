                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="{{ asset('public/storage/'.Auth::user()->profile_photo_path) }}" alt="user"></div>
                                            <div class="u-text">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						<li><a class="waves-effect waves-dark" href="{{ url('editor/myprofile') }}" aria-expanded="false"><i class="mdi mdi-broom"></i><span
                                    class="hide-menu">My Profile</span></a>
                        </li>
						<li><a class="waves-effect waves-dark" href="{{ url('editor/changepassword') }}" aria-expanded="false"><i class="mdi mdi-broom"></i><span

...
$(document).ready(function(){
	...
	$('.export').children('svg').children('g').children('ellipse').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('polygon').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('g').children('polygon').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('rect').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('g').children('rect').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('circle').click(function(){
		$(this).css('fill', global);
	})
	$('.export').children('svg').children('g').children('circle').click(function(){
		$(this).css('fill', global);
	})
	//
